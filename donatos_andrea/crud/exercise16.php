...
$conn = mysqli_connect($server, $group_name, $popular_song, 
                       $bias, $debut, $entertainment_company, $db);
...
if(!$conn) {
    ...
    echo 'You inserted successfully!';
}
    ...
    $sql = "UPDATE kpop SET kpop='{$group}', song='{$song}', 
        bias='{$bias}', debut='{$debut}', 
